        ...
        render: function () {
            var p = this.getPosition(),
                ...
                textspan = '<span class="city-picker-span" style="' +
                     'height:' + //this.getWidthStyle(p.width+70) +
                    p.height + 'px;line-height:' + (p.height - 1) + 'px;">' +
                    (placeholder ? '<span class="placeholder">' + placeholder + '</span>' : '') +
                    '<span class="title"></span>' + 
                    '<div class="qhqy-div">切换区域<i style="position:relative;top:-2px;left:3px;"><img src="../../images/cyfwImgS/down-list.png"></i></div></span>',
            ...
            this.$dropdown.find('.city-select')
                .each(function () {
                    ...
                    if (item) {
                            ...
                            if(type=='province'){
                                text += ($(this).hasClass('province') ? '' : '/') + '<span v-model="province" class="select-item" data-count="' +
