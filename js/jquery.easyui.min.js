...
(function($) {
	...
	function show(_464) {
		...
		t.find("tr").find("th:eq(" + _468 + ")").addClass("calendar-saturday");
		t.find("tr").find("th:eq(" + _469 + ")").addClass("calendar-sunday");
		...
		t.find("td").hover(function() {
			...
			// t.find("td.calendar-selected").removeClass("calendar-selected");
			$(this).addClass("calendar-selected");
	...
	$.fn.calendar.defaults = {
		...
		months: ["Jan", "February", "Mar", "Apr", "May", "June", "Jule", "Aug", "September", "Oct", "Nov", "Dec"],
