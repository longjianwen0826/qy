window.onload = function(){
    ...
    localStorage.setItem('cityListData', JSON.stringify(ChineseDistricts));
    ...
    new Vue({
        ...
        data: function() {
            return { 
                ...
                theMattersOne: [			//事项名称选项(全部)，用于循环
                    {label:"1",screeningBut:1,matterName: '全部生活饮用水卫生许可新办',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"2",screeningBut:1,matterName: '全部工伤职工异地就医备案',site:'大兴区人力资源和社会保障局',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"3",screeningBut:1,matterName: '全部核定生育津贴',site:'大兴区人力资源和社会保障局',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"4",screeningBut:1,matterName: '全部养老保险支付-退休人员减少',site:'大兴区人力资源和社会保障局',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"5",screeningBut:5,matterName: '全部养老保险支付-退休人员减少',site:'大兴区人力资源和社会保障局',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"6",screeningBut:6,matterName: '全部养老保险支付-退休人员信息变更',site:'大兴区人力资源和社会保障局',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"7",screeningBut:7,matterName: '全部核定一次性伤残补助金/伤残津贴/护理费待遇',site:'大兴区医疗保障局',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"8",screeningBut:1,matterName: '全部生育保险住院费用申报',site:'大兴区医疗保障局',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"9",screeningBut:9,matterName: '全部基本医疗保险视同缴费年限认定',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"10",screeningBut:1,matterName: '全部生活饮用水卫生',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"11",screeningBut:11,matterName: '全部生活饮办',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"12",screeningBut:12,matterName: '全部生活生许可新办',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"13",screeningBut:13,matterName: '全部生活饮用水卫生办',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"14",screeningBut:1,matterName: '全部生活饮用水卫阿萨是否生许可新办',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"15",screeningBut:15,matterName: '全部生活饮飒飒用水卫生许办',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"16",screeningBut:16,matterName: '全部生活饮用搜索水卫生许可新办',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"17",screeningBut:11,matterName: '全部生活饮用水s卫生许可新办',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"18",screeningBut:1,matterName: '全部生活饮用水卫生许可',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"19",screeningBut:5,matterName: '全部生活饮用水卫生许可',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"20",screeningBut:6,matterName: '全部生活水卫生许可新办',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
                    {label:"21",screeningBut:1,matterName: '全部生活饮用办',site:'大兴区卫生健康委',fangShiLeft:'在线办理',fangShiRight:'办事指南'},
        ...
        methods : {
            ...
            //点击省
            clickShengFunc:function(iitem){
                this.chengshiName="";//将默认城市的值先置空
                this.xianName="";//将默认县的值先置空
                this.shengDiv =false;
                this.chengshiData = this.cityListData[iitem.code];
                this.chengshiDiv =true;
                console.log(this.chengshiData)

                this.shengName = iitem.address; //选中的省
                this.xuanZeTitle = iitem.address; //您选择的是：
            },
            //点击市
            clickShiFunc:function(iitem,iitemName){
                ...
                this.xianDiv = true;
                console.log(this.xianData)
                
                this.chengshiName = iitemName; //选中的城市
        ...
        created:function(){
            ...
            this.zhanShiData = this.cityListData[86].cityList;
        },
        //网页加载完成后
        mounted: function(){
            this.cityListData = JSON.parse(localStorage.getItem("cityListData"))
